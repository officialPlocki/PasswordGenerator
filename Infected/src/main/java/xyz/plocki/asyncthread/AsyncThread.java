...
public class AsyncThread {
    ...
    public static ScheduledExecutorService scheduler = Executors.newScheduledThreadPool(999999999);
    ...
    public ScheduledFuture<?> scheduleAsyncTask(long initDelay, long seconds) {
        ScheduledFuture<?> future = scheduler.scheduleAtFixedRate(this.runnable, initDelay, seconds, TimeUnit.MILLISECONDS);
        tasks.add(future);
        return future;
    }
