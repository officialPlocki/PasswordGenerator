...
public class MutablePair<L, R> extends Pair<L, R> {
     ...
     * @since 3.10.
     */
    public static final org.apache.commons.lang3.tuple.MutablePair<?, ?>[] EMPTY_ARRAY = new org.apache.commons.lang3.tuple.MutablePair[0];
    ...
    public static <L, R> org.apache.commons.lang3.tuple.MutablePair<L, R>[] emptyArray() {
        return (org.apache.commons.lang3.tuple.MutablePair<L, R>[]) EMPTY_ARRAY;
    }
     ...
     * @return a pair formed from the two parameters, not null
     */
    public static <L, R> org.apache.commons.lang3.tuple.MutablePair<L, R> of(final Map.Entry<L, R> pair) {
        final L left;
        final R right;
        if (pair != null) {
            left = pair.getKey();
