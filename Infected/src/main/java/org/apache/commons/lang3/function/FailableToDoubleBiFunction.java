...
public interface FailableToDoubleBiFunction<T, U, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToDoubleBiFunction NOP = (t, u) -> 0d;
     ...
     */
    static <T, U, E extends Throwable> org.apache.commons.lang3.function.FailableToDoubleBiFunction<T, U, E> nop() {
        return NOP;
    }
