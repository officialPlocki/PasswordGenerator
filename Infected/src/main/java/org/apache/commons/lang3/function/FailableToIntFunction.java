...
public interface FailableToIntFunction<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToIntFunction NOP = t -> 0;
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableToIntFunction<T, E> nop() {
        return NOP;
    }
