...
public interface FailableBiPredicate<T, U, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableBiPredicate FALSE = (t, u) -> false;

    /** TRUE singleton */
    @SuppressWarnings("rawtypes")
    org.apache.commons.lang3.function.FailableBiPredicate TRUE = (t, u) -> true;
     ...
     */
    static <T, U, E extends Throwable> org.apache.commons.lang3.function.FailableBiPredicate<T, U, E> falsePredicate() {
        return FALSE;
    }
     ...
     * @return The NOP singleton.
     */
    static <T, U, E extends Throwable> org.apache.commons.lang3.function.FailableBiPredicate<T, U, E> truePredicate() {
        return TRUE;
    }
     ...
     */
    default org.apache.commons.lang3.function.FailableBiPredicate<T, U, E> and(final org.apache.commons.lang3.function.FailableBiPredicate<? super T, ? super U, E> other) {
     ...
     * @throws NullPointerException if other is null
     */
    default org.apache.commons.lang3.function.FailableBiPredicate<T, U, E> or(final org.apache.commons.lang3.function.FailableBiPredicate<? super T, ? super U, E> other) {
        Objects.requireNonNull(other);
        return (final T t, final U u) -> test(t, u) || other.test(t, u);
    }
