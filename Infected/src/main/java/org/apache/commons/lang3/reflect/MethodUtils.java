 ...
 *
 * <p>{@link org.apache.commons.lang3.reflect.MethodUtils} contains a workaround for this situation.
...
public class MethodUtils {
    ...
    /**
     * <p>{@link org.apache.commons.lang3.reflect.MethodUtils} instances should NOT be constructed in standard programming.
    ...
    public static Method getMatchingAccessibleMethod(final Class<?> cls,
        ...
        for (final Method method : methods) {
            ...
            if (method.getName().equals(methodName) &&
                    org.apache.commons.lang3.reflect.MemberUtils.isMatchingMethod(method, parameterTypes)) {
        ...
        for (final Method method : matchingMethods) {
            ...
            if (accessibleMethod != null && (bestMatch == null || org.apache.commons.lang3.reflect.MemberUtils.compareMethodFit(
                        accessibleMethod,
                        bestMatch,
                        parameterTypes) < 0)) {
    ...
    public static <A extends Annotation> A getAnnotation(final Method method, final Class<A> annotationCls,
        ...
        Validate.notNull(annotationCls, "annotationCls");
        if (!ignoreAccess && !org.apache.commons.lang3.reflect.MemberUtils.isAccessible(method)) {
            return null;
        }
