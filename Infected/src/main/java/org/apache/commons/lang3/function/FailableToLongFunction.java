...
public interface FailableToLongFunction<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToLongFunction NOP = t -> 0L;
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableToLongFunction<T, E> nop() {
        return NOP;
    }
