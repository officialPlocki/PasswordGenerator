 ...
 * @since 3.2
 */
public abstract class Triple<L, M, R> implements Comparable<org.apache.commons.lang3.tuple.Triple<L, M, R>>, Serializable {

    private static final class TripleAdapter<L, M, R> extends org.apache.commons.lang3.tuple.Triple<L, M, R> {
     ...
     * @since 3.10.
     */
    public static final org.apache.commons.lang3.tuple.Triple<?, ?, ?>[] EMPTY_ARRAY = new TripleAdapter[0];
    ...
    public static <L, M, R> org.apache.commons.lang3.tuple.Triple<L, M, R>[] emptyArray() {
        return (org.apache.commons.lang3.tuple.Triple<L, M, R>[]) EMPTY_ARRAY;
    }
