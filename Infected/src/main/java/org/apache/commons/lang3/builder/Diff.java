...
public abstract class Diff<T> extends Pair<T, T> {
    ...
    protected Diff(final String fieldName) {
        this.type = ObjectUtils.defaultIfNull(
                TypeUtils.getTypeArguments(getClass(), org.apache.commons.lang3.builder.Diff.class).get(
                        org.apache.commons.lang3.builder.Diff.class.getTypeParameters()[0]), Object.class);
