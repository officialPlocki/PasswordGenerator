...
public interface FailableDoubleFunction<R, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableDoubleFunction NOP = t -> null;
     ...
     */
    static <R, E extends Throwable> org.apache.commons.lang3.function.FailableDoubleFunction<R, E> nop() {
        return NOP;
    }
