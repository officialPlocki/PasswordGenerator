...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    private static final org.apache.commons.lang3.time.FormatCache<org.apache.commons.lang3.time.FastDateFormat> cache = new org.apache.commons.lang3.time.FormatCache<org.apache.commons.lang3.time.FastDateFormat>() {
        @Override
        protected org.apache.commons.lang3.time.FastDateFormat createInstance(final String pattern, final TimeZone timeZone, final Locale locale) {
     ...
     */
    public static org.apache.commons.lang3.time.FastDateFormat getInstance(final String pattern) {
     ...
     * @throws IllegalArgumentException if pattern is invalid
     */
    public static org.apache.commons.lang3.time.FastDateFormat getInstance(final String pattern, final TimeZone timeZone) {
     ...
     * @throws IllegalArgumentException if pattern is invalid
     */
    public static org.apache.commons.lang3.time.FastDateFormat getInstance(final String pattern, final Locale locale) {
     ...
     *  or {@code null}
     */
    public static org.apache.commons.lang3.time.FastDateFormat getInstance(final String pattern, final TimeZone timeZone, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(final int style, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(final int style, final TimeZone timeZone) {
     ...
     *  pattern defined
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateInstance(final int style, final TimeZone timeZone, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(final int style, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(final int style, final TimeZone timeZone) {
     ...
     *  pattern defined
     */
    public static org.apache.commons.lang3.time.FastDateFormat getTimeInstance(final int style, final TimeZone timeZone, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(final int dateStyle, final int timeStyle, final Locale locale) {
     ...
     * @since 2.1
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(final int dateStyle, final int timeStyle, final TimeZone timeZone) {
     ...
     *  pattern defined
     */
    public static org.apache.commons.lang3.time.FastDateFormat getDateTimeInstance(
    ...
    */
    ...
    public boolean equals(final Object obj) {
        if (!(obj instanceof org.apache.commons.lang3.time.FastDateFormat)) {
            return false;
        }
