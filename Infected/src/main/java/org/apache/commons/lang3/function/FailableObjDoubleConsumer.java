...
public interface FailableObjDoubleConsumer<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableObjDoubleConsumer NOP = (t, u) -> {/* NOP */};
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableObjDoubleConsumer<T, E> nop() {
        return NOP;
    }
