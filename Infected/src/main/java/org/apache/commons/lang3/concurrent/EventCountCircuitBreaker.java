...
public class EventCountCircuitBreaker extends AbstractCircuitBreaker<Integer> {
    ...
    private abstract static class StateStrategy {
         ...
         */
        public boolean isCheckIntervalFinished(final org.apache.commons.lang3.concurrent.EventCountCircuitBreaker breaker,
         ...
         */
        public abstract boolean isStateTransition(org.apache.commons.lang3.concurrent.EventCountCircuitBreaker breaker,
    ...
    private static class StateStrategyClosed extends StateStrategy {
         ...
         */
        @Override
        public boolean isStateTransition(final org.apache.commons.lang3.concurrent.EventCountCircuitBreaker breaker,
