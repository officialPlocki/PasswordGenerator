...
public interface FailableToDoubleFunction<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToDoubleFunction NOP = t -> 0d;
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableToDoubleFunction<T, E> nop() {
        return NOP;
    }
