...
public interface FailableLongToIntFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableLongToIntFunction NOP = t -> 0;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableLongToIntFunction<E> nop() {
        return NOP;
    }
