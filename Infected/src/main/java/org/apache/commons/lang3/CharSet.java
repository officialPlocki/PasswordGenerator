...
public class CharSet implements Serializable {
     ...
     * @since 2.0
     */
    public static final org.apache.commons.lang3.CharSet EMPTY = new org.apache.commons.lang3.CharSet((String) null);
     ...
     * @since 2.0
     */
    protected static final Map<String, org.apache.commons.lang3.CharSet> COMMON = Collections.synchronizedMap(new HashMap<>());
    ...
    private final Set<org.apache.commons.lang3.CharRange> set = Collections.synchronizedSet(new HashSet<>());
     ...
     * @since 2.4
     */
    public static org.apache.commons.lang3.CharSet getInstance(final String... setStrs) {
        if (setStrs == null) {
            return null;
        }
        if (setStrs.length == 1) {
...
//       It may be replaced when CharSet moves to Range.
    /*public*/ org.apache.commons.lang3.CharRange[] getCharRanges() {
        return set.toArray(org.apache.commons.lang3.CharRange.EMPTY_ARRAY);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof org.apache.commons.lang3.CharSet)) {
            return false;
        }
