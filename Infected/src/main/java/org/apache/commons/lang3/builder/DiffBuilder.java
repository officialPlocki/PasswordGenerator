...
public class DiffBuilder<T> implements Builder<DiffResult<T>> {
     ...
     *            is never changed throughout the life of this {@link org.apache.commons.lang3.builder.DiffBuilder}.
     ...
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final boolean lhs,
                                                                  final boolean rhs) {
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final byte lhs,
                                                                  final byte rhs) {
        validateFieldNameNotNull(fieldName);
        if (objectsTriviallyEqual) {
            return this;
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final char lhs,
                                                                  final char rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final double lhs,
                                                                  final double rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final float lhs,
                                                                  final float rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final int lhs,
                                                                  final int rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final long lhs,
                                                                  final long rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final short lhs,
                                                                  final short rhs) {
        validateFieldNameNotNull(fieldName);
     ...
     *             if field name is {@code null}
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName, final Object lhs,
                                                                  final Object rhs) {
        validateFieldNameNotNull(fieldName);
        if (objectsTriviallyEqual) {
            return this;
     ...
     * @since 3.5
     */
    public org.apache.commons.lang3.builder.DiffBuilder<T> append(final String fieldName,
