...
public interface FailableIntFunction<R, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableIntFunction NOP = t -> null;
     ...
     */
    static <R, E extends Throwable> org.apache.commons.lang3.function.FailableIntFunction<R, E> nop() {
        return NOP;
    }
