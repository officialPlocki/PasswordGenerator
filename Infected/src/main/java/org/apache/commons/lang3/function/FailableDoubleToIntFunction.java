...
public interface FailableDoubleToIntFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableDoubleToIntFunction NOP = t -> 0;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableDoubleToIntFunction<E> nop() {
        return NOP;
    }
