...
public interface FailableLongToDoubleFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableLongToDoubleFunction NOP = t -> 0d;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableLongToDoubleFunction<E> nop() {
        return NOP;
    }
