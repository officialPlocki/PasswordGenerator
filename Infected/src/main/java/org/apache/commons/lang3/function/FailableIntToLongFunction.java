...
public interface FailableIntToLongFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableIntToLongFunction NOP = t -> 0L;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableIntToLongFunction<E> nop() {
        return NOP;
    }
