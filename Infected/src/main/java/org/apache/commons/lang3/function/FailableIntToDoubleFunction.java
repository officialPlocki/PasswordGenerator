...
public interface FailableIntToDoubleFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableIntToDoubleFunction NOP = t -> 0d;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableIntToDoubleFunction<E> nop() {
        return NOP;
    }
