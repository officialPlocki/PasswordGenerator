...
public enum JavaVersion {
     ...
     * @since 3.9
     */
    public boolean atMost(final org.apache.commons.lang3.JavaVersion requiredVersion) {
        return this.value <= requiredVersion.value;
    }
    ...
    static org.apache.commons.lang3.JavaVersion getJavaVersion(final String nom) {
        return get(nom);
    }
     ...
     * version is unknown
     */
    static org.apache.commons.lang3.JavaVersion get(final String versionStr) {
        if (versionStr == null) {
            return null;
        }
        switch (versionStr) {
