...
public interface FailableToIntBiFunction<T, U, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToIntBiFunction NOP = (t, u) -> 0;
     ...
     */
    static <T, U, E extends Throwable> org.apache.commons.lang3.function.FailableToIntBiFunction<T, U, E> nop() {
        return NOP;
    }
