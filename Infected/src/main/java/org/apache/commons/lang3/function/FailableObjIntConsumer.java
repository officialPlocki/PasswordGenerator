...
public interface FailableObjIntConsumer<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableObjIntConsumer NOP = (t, u) -> {/* NOP */};
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableObjIntConsumer<T, E> nop() {
        return NOP;
    }
