...
public interface FailableLongFunction<R, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableLongFunction NOP = t -> null;
     ...
     */
    static <R, E extends Throwable> org.apache.commons.lang3.function.FailableLongFunction<R, E> nop() {
        return NOP;
    }
