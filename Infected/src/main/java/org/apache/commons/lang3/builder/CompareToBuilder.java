...
public class CompareToBuilder implements Builder<Integer> {
    ...
    private static void reflectionAppend(
        ...
        final Object rhs,
        final Class<?> clazz,
        final org.apache.commons.lang3.builder.CompareToBuilder builder,
     ...
     *  with {@code lhs}
     */
    public org.apache.commons.lang3.builder.CompareToBuilder append(final Object lhs, final Object rhs) {
     ...
     * @since 2.0
     */
    public org.apache.commons.lang3.builder.CompareToBuilder append(final Object lhs, final Object rhs, final Comparator<?> comparator) {
        if (comparison != 0) {
            return this;
        }
        if (lhs == rhs) {
