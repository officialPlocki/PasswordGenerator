...
public interface FailableObjLongConsumer<T, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableObjLongConsumer NOP = (t, u) -> {/* NOP */};
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableObjLongConsumer<T, E> nop() {
        return NOP;
    }
