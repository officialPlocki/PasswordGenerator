...
public final class Range<T> implements Serializable {
     ...
     */
    public static <T extends Comparable<T>> org.apache.commons.lang3.Range<T> between(final T fromInclusive, final T toInclusive) {
     ...
     */
    public static <T> org.apache.commons.lang3.Range<T> between(final T fromInclusive, final T toInclusive, final Comparator<T> comparator) {
     ...
     */
    public static <T extends Comparable<T>> org.apache.commons.lang3.Range<T> is(final T element) {
     ...
     * @throws ClassCastException if using natural ordering and the elements are not {@code Comparable}
     */
    public static <T> org.apache.commons.lang3.Range<T> is(final T element, final Comparator<T> comparator) {
