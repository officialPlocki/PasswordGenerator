...
public interface FailableFunction<T, R, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableFunction NOP = t -> null;
     ...
     */
    static <T, E extends Throwable> org.apache.commons.lang3.function.FailableFunction<T, T, E> identity() {
        return t -> t;
    }
     ...
     */
    static <T, R, E extends Throwable> org.apache.commons.lang3.function.FailableFunction<T, R, E> nop() {
        return NOP;
    }
     ...
     */
    default <V> org.apache.commons.lang3.function.FailableFunction<T, V, E> andThen(final org.apache.commons.lang3.function.FailableFunction<? super R, ? extends V, E> after) {
     ...
     * @see #andThen(org.apache.commons.lang3.function.FailableFunction)
     */
    default <V> org.apache.commons.lang3.function.FailableFunction<V, R, E> compose(final org.apache.commons.lang3.function.FailableFunction<? super V, ? extends T, E> before) {
