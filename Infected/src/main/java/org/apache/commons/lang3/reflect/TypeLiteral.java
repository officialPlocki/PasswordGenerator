 ...
 * </p>
 * <p>Additionally {@link org.apache.commons.lang3.reflect.TypeLiteral} implements the {@link Typed} interface which
...
public abstract class TypeLiteral<T> implements Typed<T> {
    ...
    private static final TypeVariable<Class<org.apache.commons.lang3.reflect.TypeLiteral>> T = org.apache.commons.lang3.reflect.TypeLiteral.class.getTypeParameters()[0];
    ...
    protected TypeLiteral() {
        this.value =
            Validate.notNull(TypeUtils.getTypeArguments(getClass(), org.apache.commons.lang3.reflect.TypeLiteral.class).get(T),
                "%s does not assign type parameter %s", getClass(), TypeUtils.toLongString(T));

        this.toString = String.format("%s<%s>", org.apache.commons.lang3.reflect.TypeLiteral.class.getSimpleName(), TypeUtils.toString(value));
    }
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof org.apache.commons.lang3.reflect.TypeLiteral)) {
            return false;
        }
