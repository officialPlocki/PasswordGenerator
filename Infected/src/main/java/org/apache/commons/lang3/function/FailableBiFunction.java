...
public interface FailableBiFunction<T, U, R, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableBiFunction NOP = (t, u) -> null;
     ...
     */
    static <T, U, R, E extends Throwable> org.apache.commons.lang3.function.FailableBiFunction<T, U, R, E> nop() {
        return NOP;
    }
     ...
     */
    default <V> org.apache.commons.lang3.function.FailableBiFunction<T, U, V, E> andThen(final FailableFunction<? super R, ? extends V, E> after) {
