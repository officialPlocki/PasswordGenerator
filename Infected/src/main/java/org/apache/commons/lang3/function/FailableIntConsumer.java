...
public interface FailableIntConsumer<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableIntConsumer NOP = t -> {/* NOP */};
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableIntConsumer<E> nop() {
        return NOP;
    }
     ...
     */
    default org.apache.commons.lang3.function.FailableIntConsumer<E> andThen(final org.apache.commons.lang3.function.FailableIntConsumer<E> after) {
