...
public interface FailableToLongBiFunction<T, U, E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableToLongBiFunction NOP = (t, u) -> 0;
     ...
     */
    static <T, U, E extends Throwable> org.apache.commons.lang3.function.FailableToLongBiFunction<T, U, E> nop() {
        return NOP;
    }
