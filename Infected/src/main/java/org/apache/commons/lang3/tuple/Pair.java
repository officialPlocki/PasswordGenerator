...
public abstract class Pair<L, R> implements Map.Entry<L, R>, Comparable<org.apache.commons.lang3.tuple.Pair<L, R>>, Serializable {
     ...
     * @since 3.10.
     */
    public static final org.apache.commons.lang3.tuple.Pair<?, ?>[] EMPTY_ARRAY = new PairAdapter[0];
    ...
    public static <L, R> org.apache.commons.lang3.tuple.Pair<L, R>[] emptyArray() {
        return (org.apache.commons.lang3.tuple.Pair<L, R>[]) EMPTY_ARRAY;
    }
     ...
     * @since 3.10
     */
    public static <L, R> org.apache.commons.lang3.tuple.Pair<L, R> of(final Map.Entry<L, R> pair) {
