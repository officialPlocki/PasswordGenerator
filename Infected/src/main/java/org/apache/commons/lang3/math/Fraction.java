 ...
 * @since 2.0
 */
public final class Fraction extends Number implements Comparable<org.apache.commons.lang3.math.Fraction> {
     ...
     */
    public static org.apache.commons.lang3.math.Fraction getFraction(String str) {
    ...
    public org.apache.commons.lang3.math.Fraction pow(final int power) {
        if (power == 1) {
            ...
            final org.apache.commons.lang3.math.Fraction f = this.multiplyBy(this);
    ...
    private org.apache.commons.lang3.math.Fraction addSub(final org.apache.commons.lang3.math.Fraction fraction, final boolean isAdd) {
        ...
        if (d1 == 1) {
            ...
            return new org.apache.commons.lang3.math.Fraction(isAdd ? addAndCheck(uvp, upv) : subAndCheck(uvp, upv), mulPosAndCheck(denominator,
        ...
        return new org.apache.commons.lang3.math.Fraction(w.intValue(), mulPosAndCheck(denominator / d1, fraction.denominator / d2));
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof org.apache.commons.lang3.math.Fraction)) {
            return false;
        }
