...
public final class ImmutablePair<L, R> extends Pair<L, R> {
     ...
     * @since 3.10.
     */
    public static final org.apache.commons.lang3.tuple.ImmutablePair<?, ?>[] EMPTY_ARRAY = new org.apache.commons.lang3.tuple.ImmutablePair[0];
    ...
    private static final org.apache.commons.lang3.tuple.ImmutablePair NULL = of(null, null);
    ...
    public static <L, R> org.apache.commons.lang3.tuple.ImmutablePair<L, R>[] emptyArray() {
        return (org.apache.commons.lang3.tuple.ImmutablePair<L, R>[]) EMPTY_ARRAY;
    }
     ...
     * @since 3.10
     */
    public static <L, R> org.apache.commons.lang3.tuple.ImmutablePair<L, R> of(final Map.Entry<L, R> pair) {
        final L left;
        final R right;
        if (pair != null) {
            left = pair.getKey();
