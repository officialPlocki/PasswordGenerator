...
public interface FailableDoubleToLongFunction<E extends Throwable> {
    ...
    org.apache.commons.lang3.function.FailableDoubleToLongFunction NOP = t -> 0;
     ...
     */
    static <E extends Throwable> org.apache.commons.lang3.function.FailableDoubleToLongFunction<E> nop() {
        return NOP;
    }
